...
import { ReloadOutlined, EyeOutlined, DeleteOutlined, CheckOutlined } from "@ant-design/icons";
...
const VerifyAccountManagement: React.FC = () => {
...
export default VerifyAccountManagement;